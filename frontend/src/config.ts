...
export const CONTRACT_ID = import.meta.env.VITE_CONTRACT_ID || 'CDEIL2ZNURMZP66QIWTLZ5SPG4MDVT6UFWTPLSDE6B2R3N6UJEMV7KND';

// Soroban wrapped XLM token on testnet
